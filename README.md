...
2. Determine the full path of the file you want to copy from the container.
3. Use the  docker cp  command to copy the file from the container to your local
