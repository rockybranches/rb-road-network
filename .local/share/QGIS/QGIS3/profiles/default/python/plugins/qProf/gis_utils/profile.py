...
InSectionPlotLines = namedtuple("InSectionPlotLines", "multilines2d ids colors plot_labels")
...
class GeoProfile:
    ...
    def __init__(self):
        ...
        # line traces projections (geosurfaces in 3D)
        self.geosurfaces = []
    ...
    def add_curves(self,
        ...
        multiline_plot_set = InSectionPlotLines(
            lMultilines,
            lIds,
            colors,
            plot_labels
        ...
        self.geosurfaces.append(multiline_plot_set)
